  ...
  return (
    <main style={S.main}>
      ...
      <div style={S.artWrap}>
        ...
        <h1 style={S.artTitle}>{bio.isim}</h1>
        <div style={S.artMeta}>{bio.tarih}</div>
        <p style={{ ...S.artP, color: "#bbb", fontSize: "0.93rem", lineHeight: 1.9, marginBottom: "2.5rem" }}>{bio.ozet}</p>
        {bio.bolumler.map((b, i) => (
